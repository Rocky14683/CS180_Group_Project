                ...
                if (user == null) {
                    ...
                    switch (cmd) {
                        ...
                        case "makeComment": {
                            ...
                            if (dataWriter.makeComment(dataWriter.redefinePost(postCode), comment)) { //makes comment
                        ...
                        case "likeComment": {
                            ...
                            Comment comment = dataWriter.redefineComment(postCode, commentCode);
                        ...
                        case "deleteComment": {
                            ...
                            Comment comment = dataWriter.redefineComment(postCode, commentCode);
                            if (dataWriter.delete(comment, user)) { //deletes comment
