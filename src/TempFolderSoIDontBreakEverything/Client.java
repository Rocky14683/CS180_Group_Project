...
//                 while (!GUI.isSomethingHappened()) { System.out.printf("");}
//                 System.out.println("passed somethingHappened");
//                 String option = GUI.getCommand();// this is where the GUI for login/register will be
...
//                                 String search = GUI.getSearchTerm();
//                                 System.out.println("Sending:" + search);
//                                 writer.write(search);
//                                 writer.newLine();
//                                 writer.flush();
//                                 String[] searchReturn = reader.readLine().split(";;");
//                                 GUI.setSearchResults(searchReturn);
//                                 GUI.setCommand(null);
//                                 GUI.setSomethingHappened(false);
